    ...
    <div className="about-us">
      ...
      <section className="content">
        ...
        <div className="developer">
          ...
          <h4>Key AI Projects:</h4>
          <ul>
            <li>AI-Powered Workout Recommendation System</li>
            <li>Machine Learning Models for Personalized Fitness Analytics</li>
            <li>Intelligent Chatbot Assistant for Real-Time Coaching</li>
            <li>Automated Threat Intelligence Platform for Cybersecurity</li>
          </ul>
        </div>
